...
const rabbitmq_1 = __webpack_require__("./libs/packages/rabbitmq/src/index.ts");
const gmail_1 = __webpack_require__("./libs/robot/gmail/src/index.ts");
const hotmail_1 = __webpack_require__("./libs/robot/hotmail/src/index.ts");
const common_1 = __webpack_require__("@nestjs/common");
const script_module_1 = __webpack_require__("./apps/robots/robot-actions/src/app/script.module.ts");
...
AppModule = tslib_1.__decorate([
    (0, common_1.Module)({
        imports: [
            script_module_1.ScriptModule.registerAsync([gmail_1.Gmail, hotmail_1.Hotmail, proton_1.Proton]),
...
/***/ "./apps/robots/robot-actions/src/app/script.module.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/robots/robot-actions/src/app/task.service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var TaskService_1, _a, _b;
Object.defineProperty(exports, "__esModule", ({ value: true }));
...
let TaskService = TaskService_1 = class TaskService {
    ...
    getTask(id) {
        return this.application.getTask(id);
    }
    executeTask(task) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    stopTaskById(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.application.stopTaskById(id);
        });
    }
    getTasks() {
        return this.application.getTasks();
    }
    getTasksByTaskName(taskName) {
        return this.application.getTasksByTaskName(taskName);
    }
    getResultByTaskId(id) {
        return this.application.getResultByTaskId(id);
    }
    getResponseByTaskId(id) {
        return this.application.getResponseByTaskId(id);
    }
};
TaskService = TaskService_1 = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__param(0, (0, common_1.Inject)(script_module_1.APPLICATION_PROVIDER)),
    tslib_1.__param(1, (0, rabbitmq_1.InjectChannel)()),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof core_1.Application !== "undefined" && core_1.Application) === "function" ? _a : Object, typeof (_b = typeof amqplib_1.Channel !== "undefined" && amqplib_1.Channel) === "function" ? _b : Object])
], TaskService);
...
const tslib_1 = __webpack_require__("tslib");
const core_1 = __webpack_require__("./libs/robot/core/src/index.ts");
const handler_1 = __webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/index.ts");
const service_1 = __webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/service/index.ts");
class GmailAuthHandler extends core_1.AuthHandler {
    handle(context, email, payload, result) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            handlerService.signHandler(new handler_1.EmailHandler(page, email));
            handlerService.signHandler(new handler_1.EmailWrongHandler(page, email));
            handlerService.signHandler(new handler_1.PasswordHandler(page, email));
            handlerService.signHandler(new handler_1.PasswordWrongHandler(page, email));
            handlerService.signHandler(new handler_1.ChallengeHandler(page, email));
            handlerService.signHandler(new handler_1.ConfirmationEmailHandler(page, email));
            handlerService.signHandler(new handler_1.ConfirmationEmailWrongHandler(page, email));
            handlerService.signHandler(new handler_1.PhoneHandler(page, email));
            handlerService.signHandler(new handler_1.DisabledAccountHandler(page, email));
            handlerService.signHandler(new handler_1.EndHandler(page, email));
            const authService = new service_1.AuthService(page, routingService, handlerService);
...
const model_1 = __webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/model/index.ts");
const handler_enum_1 = __webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/handler.enum.ts");
class ChallengeHandler extends model_1.Handler {
    ...
    handle() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if ((available === null || available === void 0 ? void 0 : available.toString()) == 'true') {
                return (0, shared_1.fail)('Confirmation by email is temporary unavailable');
            }
            locator.nth(0).click();
    ...
    waitFor(res) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (payload) {
                return payload.includes('1,\\"accounts.google.com/signin/v2/challenge/selection');
            }
            return false;
        });
    }
    validate() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const input = yield this.page.waitForSelector('[data-challengetype] >> visible=true', {
                    timeout: 5000,
                });
                if (input)
                    return (0, shared_1.success)(true);
                else
                    return (0, shared_1.fail)('Challenges not Found!');
            }
            catch (e) {
                console.log(e);
...
class ConfirmationEmailWrongHandler extends model_1.Handler {
    constructor() {
        super(...arguments);
        this.name = handler_enum_1.HandlerEnum.CONFIRMATION_EMAIL_WRONG_HANDLER;
    }
    handle() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    waitFor(res) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (res.url().includes('signin/challenge')) {
                ...
                if (body.includes(this.email.email.toLowerCase()) &&
    ...
    validate() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const input = yield this.page.waitForSelector('input[type="email"] >> visible=true', {
                    timeout: 5000,
                });
                if (input)
                    return (0, shared_1.success)(true);
                else
                    return (0, shared_1.fail)('Confirmation Input not Found!');
            }
            catch (e) {
                console.log(e);
                return (0, shared_1.fail)(e.message);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (input)
                    ...
                    return (0, shared_1.fail)('Input not Found!');
            }
            catch (e) {
                console.log(e);
                return (0, shared_1.fail)(e.message);
...
class DisabledAccountHandler extends model_1.Handler {
    ...
    validate() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const input = yield this.page.waitForSelector('[data-is-secondary-action-disabled="false"] >> visible=true', {
                    timeout: 5000,
                });
                if (input)
                    return (0, shared_1.success)(true);
                else
                    return (0, shared_1.fail)('Section is not found');
            }
            catch (e) {
                console.log(e);
                return (0, shared_1.fail)(e.message);
...
class EmailWrongHandler extends model_1.Handler {
    ...
    validate() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const input = yield this.page.waitForSelector('input[type="email"]', {
                    timeout: 5000,
                });
                if (input)
                    return (0, shared_1.success)(true);
...
class EndHandler extends model_1.Handler {
    ...
    validate() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const input = yield this.page.waitForSelector('[data-legacy-last-message-id] >> visible=true', {
                    timeout: 5000,
                });
                if (input)
                    return (0, shared_1.success)(true);
                else
                    return (0, shared_1.fail)('role="tabpanel"');
            }
            catch (e) {
                console.log(e);
                return (0, shared_1.fail)(e.message);
...
(function (HandlerEnum) {
    ...
    HandlerEnum["CONFIRMATION_EMAIL_HANDLER"] = "CONFIRMATION_EMAIL_HANDLER";
    HandlerEnum["CONFIRMATION_EMAIL_WRONG_HANDLER"] = "CONFIRMATION_EMAIL_WRONG_HANDLER";
...
const tslib_1 = __webpack_require__("tslib");
const email_wrong_handler_1 = __webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/email-wrong.handler.ts");
const email_handler_1 = __webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/email.handler.ts");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/handler.enum.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/email.handler.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/email-wrong.handler.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/password.handler.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/passowrd-wrong.handler.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/challenge.handler.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/confirmation-email.handler.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/confirmation-email-wrong.handler.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/phone.handler.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/disabled-account.handler.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/handler/end.handler.ts"), exports);
exports.HANDLERS = [email_handler_1.EmailHandler, email_wrong_handler_1.EmailWrongHandler];
...
class PasswordWrongHandler extends model_1.Handler {
    ...
    waitFor(res) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (res.url().includes('pwd')) {
                const body = yield res.text();
                if (body.toLowerCase().includes('INCORRECT_ANSWER_ENTERED'.toLowerCase()) &&
    ...
    validate() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const input = yield this.page.waitForSelector('input[type="password"] >> visible=true', {
                    timeout: 5000,
                });
                if (input)
                    return (0, shared_1.success)(true);
...
class PasswordHandler extends model_1.Handler {
    ...
    waitFor(res) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (res.url().includes('pwd')) {
                const body = yield res.text();
                if (body.toLowerCase().includes('INITIALIZED'.toLowerCase()) &&
                    body.toLowerCase().includes('FIRST_AUTH_FACTOR'.toLowerCase())) {
                    return true;
                }
            }
...
class PhoneHandler extends model_1.Handler {
    ...
    validate() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const input = yield this.page.waitForSelector('input[name="deviceAddress"] >> visible=true', {
                    timeout: 5000,
                });
                if (input)
                    return (0, shared_1.success)(true);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/auth-handler2.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/model/handler.ts"), exports);
...
class AuthService {
    ...
    Authenticate(email) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.page.goto('https://accounts.google.com/AccountChooser/signinchooser?service=mail&continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&flowName=GlifWebSignIn&flowEntry=AccountChooser&hl=en', {
                waitUntil: 'commit',
            });
            const loop = true;
            while (loop) {
                console.log('Next Loop!');
                const HANDLER_NAME_RESULT = yield this.RoutingService.waitForNextHandler(this.handlerService.getHandlers());
                if (HANDLER_NAME_RESULT.isFail) {
                    return (0, shared_2.fail)('Error : No Handler is created Yet');
                }
                ...
                if (HANDLER_NAME === handler_1.HandlerEnum.END) {
                    ...
                    if (handler.isFail)
                        return (0, shared_2.fail)(handler.error);
                    else {
                        const validationResult = yield handler.value.validate();
                        if (validationResult.isFail)
                            return (0, shared_2.fail)(`Handler ${HANDLER_NAME} is Wrong`);
                        const result = yield handler.value.handle();
                        if (result.isFail)
                            return (0, shared_2.fail)(result.error);
                        if (result.value) {
    ...
    getResult(context) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deflated = (0, zlib_1.deflateSync)(JSON.stringify(JSON.stringify(yield context.storageState()))).toString('base64');
...
class HandlerService {
    ...
    getHandler(target) {
        ...
        if (handler)
            return (0, shared_1.success)(handler);
        else
            return (0, shared_1.fail)('handler not found');
    }
    getHandlers() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/service/auth.service.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/service/handler.service.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/service/routing.service.ts"), exports);
...
class RoutingService {
    ...
    waitForNextHandler(handlers) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let response;
            try {
                response = yield this.page.waitForResponse((res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    for (const handler of handlers) {
                        if ((yield handler[1].waitFor(res)) &&
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-change-name-handler/src/lib/change-name-handler.ts"), exports);
...
class GmailChangeNameHandler extends core_1.ChangeNameHandler {
    ...
    handle(context, email, payload, result) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield page.goto('https://mail.google.com/mail/u/0/?tab=rm&ogbl#settings/accounts');
    ...
    addNewAlias(context, email, payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const page = context.pages()[0];
            const locators = yield page.locator('tr > td > span[role="link"][idlink][tabindex="0"]');
            ...
            if (!newpage)
                throw new Error("can't access add alias page");
            yield page.waitForTimeout(2000);
    ...
    createNewAliasEmail({ email }, { withPlus, extension, numberOfPoints }) {
    ...
    deleteOldAlias(page) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let locators = page.locator('tbody > tr:nth-child(2) > td:nth-child(4) > span');
    ...
    makeLastAsDefault(page) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const locator = yield page.locator('tbody > tr:nth-child(2) > td:nth-child(2) > span[role]');
            if ((yield locator.count()) == 0) {
    ...
    getCurrentName(page) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const locator = page.locator('tbody>tr:nth-child(4)>td:nth-child(2)>table:nth-child(1)>tbody>tr', {
            ...
            switch (count) {
                ...
                case 1:
                    return yield locator.locator('td:first-child').nth(0).innerText();
                default:
                    return yield page
                        .locator('tbody>tr:nth-child(4)>td:nth-child(2)>table:nth-child(1)>tbody>tr', {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-remove-devices-handler/src/remove-devices-handler.ts"), exports);
...
class GmailRemoveDevicesHandler extends core_1.RemoveDeviceHandler {
    ...
    handle(context, email, payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const page = context.pages()[0];
            yield page.goto('https://myaccount.google.com/device-activity/?hl=en');
            const locators = yield page.locator('div > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > ul:nth-child(1) > li a');
            const ids = [];
            ...
            for (const id of ids) {
                if (id)
                    yield this.removeDevice(page, id);
            }
            return {};
        });
    }
    removeDevice(page, id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield page.goto(`https://myaccount.google.com/device-activity/id/${id}?hl=en`);
...
class FilterHandler {
    ...
    filter(filter) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            console.log('hello');
            yield this.page.goto(`https://mail.google.com/mail/u/0/#search/${filter}?hl=en`);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-reply-handler/src/reply-handler.ts"), exports);
...
const tslib_1 = __webpack_require__("tslib");
const core_1 = __webpack_require__("./libs/robot/core/src/index.ts");
const filter_handler_1 = __webpack_require__("./libs/handlers/gmail/gmail-reply-handler/src/handlers/filter.handler.ts");
const message_service_1 = __webpack_require__("./libs/handlers/gmail/gmail-reply-handler/src/services/message.service.ts");
    ...
    handle(context, email, payload, res) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            while (res.count < payload.limit) {
                ...
                if (messages.value.messages.length === 0)
                    break;
                for (const message of messages.value.messages) {
                    if (res.count >= payload.limit)
                        break;
...
class MessageService {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const messages = yield this.page.evaluate((date) => {
                ...
                for (let i = 0; i < trs.length; i++) {
                    ...
                    const tooltipsContainer = tr.querySelectorAll('span[role="button"][data-tooltip]');
                    const classes = tr.getAttribute('class');
                    const message = {
                        from: (_a = fromContainer === null || fromContainer === void 0 ? void 0 : fromContainer.textContent) !== null && _a !== void 0 ? _a : '',
                        email: (_b = fromContainer === null || fromContainer === void 0 ? void 0 : fromContainer.getAttribute('email')) !== null && _b !== void 0 ? _b : '',
                        subject: (_c = subjectContainer === null || subjectContainer === void 0 ? void 0 : subjectContainer.textContent) !== null && _c !== void 0 ? _c : '',
                        dataThreadId: (_d = subjectContainer === null || subjectContainer === void 0 ? void 0 : subjectContainer.getAttribute('data-thread-id')) !== null && _d !== void 0 ? _d : '',
                        date: Date.parse((_e = dateContainer === null || dateContainer === void 0 ? void 0 : dateContainer.getAttribute('title')) !== null && _e !== void 0 ? _e : ''),
                        id: (_f = subjectContainer === null || subjectContainer === void 0 ? void 0 : subjectContainer.getAttribute('data-legacy-last-message-id')) !== null && _f !== void 0 ? _f : '',
                        isRead: (_g = !(classes === null || classes === void 0 ? void 0 : classes.includes('zE'))) !== null && _g !== void 0 ? _g : false,
                        isStarred: false,
                        isImportant: false,
                    };
                    for (let i = 0; i < tooltipsContainer.length; i++) {
                        ...
                        switch (tooltipText === null || tooltipText === void 0 ? void 0 : tooltipText.trim()) {
                            case 'Not starred':
                ...
                const nextContainer = document.querySelectorAll('div[aria-label="Older"]');
                let hasNext = !(((_h = nextContainer === null || nextContainer === void 0 ? void 0 : nextContainer.item(nextContainer.length - 1).getAttribute('aria-disabled')) === null || _h === void 0 ? void 0 : _h.toString()) === 'true');
                if (hasNext &&
                    messages.length > 0 &&
    ...
    openMessage(message) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.page.waitForSelector('tbody > tr:nth-child(1) > td:nth-child(4)> div:nth-child(1)[role="button"]');
    ...
    openReplyBox() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const locator = yield this.page.locator('tbody > tr:nth-child(1) > td:nth-child(4)> div:nth-child(1)[role="button"]');
            const count = yield locator.count();
            if (count > 0) {
                yield locator.nth(0).click();
            }
            ...
            yield this.page.waitForSelector('div[data-tooltip="Show trimmed content"]');
    ...
    resetReplyBox() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const locator = this.page.locator('div[data-tooltip="Show trimmed content"]');
            const count = yield locator.count();
            if (count > 0) {
                yield locator.nth(0).click();
            }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/gmail/gmail-setup-rule-handler/src/setup-rule.handler.ts"), exports);
...
class GmailSetupRuleHandler extends core_1.SetupRuleHandler {
    handle(context, email, payload, result) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const page = context.pages()[0];
            console.log('start');
            yield page.goto('https://mail.google.com/mail/u/0/?tab=rm&hl=en&ogbl#settings/filters');
    ...
    addInboxRule(page) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const locator = page.locator('tr[role="listitem"] > td:first-child> span:first-child[role="link"][idlink]');
            yield locator.nth(0).click();
            yield page.waitForTimeout(2000);
            console.log('[SETUP RULE] MARK 1 Byte as A Filter');
            yield page.type('div > div:first-child > div:nth-child(2)>div:nth-child(6)>div:nth-child(3)>input', '1');
            yield page.click('div > div:first-child > div:nth-child(2)>div:nth-child(6)>div:nth-child(4) div[role="listbox"]');
            yield page.click('div > div:first-child > div:nth-child(2)>div:nth-child(6)>div:nth-child(4) div[role="listbox"] > div[role="option"]:nth-child(3)');
            yield page.waitForTimeout(700);
            console.log('[SETUP RULE] CLICK CREATE FILTER');
            yield page.click('div > div:first-child > div:nth-child(2)>div:nth-child(8)>div:nth-child(2)');
            yield page.waitForTimeout(500);
            console.log('[SETUP RULE] CHECK MOVE TO INBOX');
            yield page.click('div > div:first-child > div:nth-child(2)>div:nth-child(3)> div:first-child > div:nth-child(7)> label');
            console.log('[SETUP RULE] CHECK MOVE TO PRIMARY');
            yield page.click('div > div:first-child > div:nth-child(2)>div:nth-child(3)> div:first-child > div:nth-child(10)>div:nth-child(3)');
            yield page.waitForTimeout(500);
            yield page.click('div > div:first-child > div:nth-child(2)>div:nth-child(3)> div:first-child > div:nth-child(10)>div:nth-child(4)>div:nth-child(2)');
            yield page.waitForTimeout(500);
            console.log('[SETUP RULE] SAVE FILTER');
            yield page.click('div > div:first-child > div:nth-child(2)>div:nth-child(4)> div:first-child');
        });
    }
    addIgnoreRule(page) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            console.log('[SETUP RULE] OPEN SEARCH BOX');
            yield page.click('tr[role="listitem"] > td:first-child> span:first-child[role="link"][idlink]');
            console.log('[SETUP RULE] FILL FROM INPUT');
            yield page.type('div > div:first-child > div:nth-child(2) > div:first-child > span:nth-child(2) > input', 'mailer-daemon@googlemail.com');
            console.log('[SETUP RULE] CLICK CREATE FILTER');
            yield page.click('div > div:first-child > div:nth-child(2)>div:nth-child(8)>div:nth-child(2)');
            console.log('[SETUP RULE] CHECK MARK AS READ');
            yield page.click('div > div:first-child > div:nth-child(2)>div:nth-child(3)> div:first-child > div:nth-child(2) > label');
            console.log('[SETUP RULE] SAVE FILTER');
            yield page.click('div > div:first-child > div:nth-child(2)>div:nth-child(4)> div:first-child');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/hotmail/hotmail-auth-handler/src/lib/auth-handler.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/proton/proton-auth-handler/src/lib/auth-handler.ts"), exports);
...
class ProtonAuthHandler extends core_1.AuthHandler {
    ...
    handle(context, email, payload, result) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const page = context.pages()[0];
            yield page.goto('https://account.proton.me/login?language=en&product=mail');
            ...
            yield page.waitForSelector('body > div.app-root > div.flex.flex-row.flex-nowrap.h100 > div > div > div > div.sidebar.flex.flex-nowrap.flex-column.no-print.outline-none > div.flex-item-fluid.flex-nowrap.flex.flex-column.scroll-if-needed.pb1 > nav > div > ul > li:nth-child(1)');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/proton/proton-change-name-handler/src/lib/change-name-handler.ts"), exports);
...
class ProtonChangeNameHandler extends core_1.ChangeNameHandler {
    ...
    handle(context, email, payload, result) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const page = context.pages()[0];
            console.log('[CHANGE_NAME] start');
            yield page.goto('https://account.proton.me/u/0/mail/identity-addresses');
            yield page.waitForSelector('#displayName');
            yield page.click('#displayName', {
                clickCount: 3,
            });
            yield page.type('#displayName', payload.name);
            yield page.click('#name-signature > div > form > div:nth-child(2) > div.settings-layout-right > button');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/handlers/proton/proton-setup-rule-handler/src/setup-rule.handler.ts"), exports);
...
class ProtonSetupRuleHandler extends core_1.SetupRuleHandler {
    handle(context, email, payload, result) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield page.click('#custom > div > div > button.button.button-solid-norm.on-mobile-mb0-5.mr1');
            yield page.waitForSelector('#name');
            yield page.type('#name', Math.ceil(Math.random() * 10000).toString());
            yield page.click('body > div.modal-two > dialog > form > div.modal-two-footer > div > button');
            yield page.waitForSelector('select');
            console.log('select option');
            yield page.selectOption('select', 'sender');
            yield page.selectOption('div > div:nth-child(1) > span:nth-child(2) > span > span > select', '!contains');
            yield page.type('div > div:nth-child(2) > div > div > span > input', '|||||||||||||||||||||||||||');
            yield page.click('div > div:nth-child(2) > div > div > button');
            yield page.waitForTimeout(500);
            yield page.click('dialog > form > div.modal-two-footer > div > button');
            yield page.waitForSelector('#memberSelect');
            yield page.click('#memberSelect');
            yield page.waitForTimeout(500);
            yield page.click('div.dropdown-content > ul > li:nth-child(5) > button');
            yield page.waitForTimeout(500);
            yield page.click('form > div.modal-two-footer > div > button.button.button-solid-norm');
            yield page.waitForTimeout(2000);
            return result;
        });
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/packages/rabbitmq/src/decorators/inject-channel.decorator.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/packages/rabbitmq/src/rabbitmq.module.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/packages/rabbitmq/src/interfaces/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/packages/rabbitmq/src/decorators/index.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/packages/rabbitmq/src/interfaces/rabbitmq-module.option.ts"), exports);
...
let RabbitMQModule = RabbitMQModule_1 = class RabbitMQModule {
    static forRootAsync(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            common_1.Logger.log(`Connected to RabbitMQ server`, 'RabbitMQModule');
            const p = [];
            for (const task of options.tasks) {
                p.push(channel.assertQueue(task, {
                    durable: true,
                }));
            }
            p.push(channel.assertQueue('RESPONSE', {
                durable: true,
            }));
            p.push(channel.assertQueue('UNDO', {
                durable: true,
            }));
            yield Promise.all(p);
...
const controller_1 = __webpack_require__("./libs/robot/core/src/core/controller.ts");
...
var auth_controller_1 = __webpack_require__("./libs/robot/core/src/controllers/auth.controller.ts");
Object.defineProperty(exports, "AuthController", ({ enumerable: true, get: function () { return auth_controller_1.AuthController; } }));
var change_name_controller_1 = __webpack_require__("./libs/robot/core/src/controllers/change-name.controller.ts");
Object.defineProperty(exports, "ChangeNameController", ({ enumerable: true, get: function () { return change_name_controller_1.ChangeNameController; } }));
...
const tslib_1 = __webpack_require__("tslib");
const shared_1 = __webpack_require__("./libs/views/shared/src/index.ts");
const browser_manager_1 = __webpack_require__("./libs/robot/core/src/managers/browser.manager.ts");
class Application {
    constructor() {
        this.isps = new Map();
    ...
    executeTask(task) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!isp)
                throw new Error(`ISP ${task.isp} not found`);
            ...
            const { context, stoper } = yield this.browserManager.createNewContext(task.id, task.email.session);
            yield this.browserManager.createNewPage(context);
            const tmp = yield controller.execute(context, task, stoper, result, response);
            console.log(tmp);
    ...
    stopTaskById(id) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield resolver((_a = this.results.get(id)) !== null && _a !== void 0 ? _a : new shared_1.Result());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Controller = exports.buildFailResponse = exports.buildSuccessResponse = void 0;
const tslib_1 = __webpack_require__("tslib");
    ...
    execute(context, task, stoper, result, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!handler)
                    throw new Error(`Handler ${task.action} not found`);
                console.log(handler);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Isp = exports.Handler = exports.Controller = exports.Application = void 0;
var application_1 = __webpack_require__("./libs/robot/core/src/core/application.ts");
Object.defineProperty(exports, "Application", ({ enumerable: true, get: function () { return application_1.Application; } }));
var controller_1 = __webpack_require__("./libs/robot/core/src/core/controller.ts");
Object.defineProperty(exports, "Controller", ({ enumerable: true, get: function () { return controller_1.Controller; } }));
var handler_1 = __webpack_require__("./libs/robot/core/src/core/handler.ts");
...
Object.defineProperty(exports, "Isp", ({ enumerable: true, get: function () { return isp_1.Isp; } }));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ISP = void 0;
var isp_decorator_1 = __webpack_require__("./libs/robot/core/src/decorators/isp.decorator.ts");
Object.defineProperty(exports, "ISP", ({ enumerable: true, get: function () { return isp_decorator_1.ISP; } }));
...
const handler_1 = __webpack_require__("./libs/robot/core/src/core/handler.ts");
const shared_1 = __webpack_require__("./libs/views/shared/src/index.ts");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SetupRuleHandler = exports.ReplyHandler = exports.RemoveDeviceHandler = exports.ChangeNameHandler = exports.AuthHandler = void 0;
var auth_handler_1 = __webpack_require__("./libs/robot/core/src/handlers/auth.handler.ts");
Object.defineProperty(exports, "AuthHandler", ({ enumerable: true, get: function () { return auth_handler_1.AuthHandler; } }));
var change_name_handler_1 = __webpack_require__("./libs/robot/core/src/handlers/change-name.handler.ts");
Object.defineProperty(exports, "ChangeNameHandler", ({ enumerable: true, get: function () { return change_name_handler_1.ChangeNameHandler; } }));
var remove_devices_handler_1 = __webpack_require__("./libs/robot/core/src/handlers/remove-devices.handler.ts");
Object.defineProperty(exports, "RemoveDeviceHandler", ({ enumerable: true, get: function () { return remove_devices_handler_1.RemoveDeviceHandler; } }));
var reply_handler_1 = __webpack_require__("./libs/robot/core/src/handlers/reply.handler.ts");
Object.defineProperty(exports, "ReplyHandler", ({ enumerable: true, get: function () { return reply_handler_1.ReplyHandler; } }));
var setup_rule_handler_1 = __webpack_require__("./libs/robot/core/src/handlers/setup-rule.handler.ts");
Object.defineProperty(exports, "SetupRuleHandler", ({ enumerable: true, get: function () { return setup_rule_handler_1.SetupRuleHandler; } }));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/robot/core/src/handlers/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/robot/core/src/controllers/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/robot/core/src/core/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/robot/core/src/managers/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/robot/core/src/decorators/index.ts"), exports);
...
class BrowserManager {
    ...
    createNewContext(taskId, session) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (session) {
                const s = JSON.parse((0, zlib_1.inflateSync)(Buffer.from(session, 'base64')).toString());
    ...
    getContextId(context) {
        return (0, crypto_1.createHash)('md5').update(JSON.stringify(context)).digest('hex');
    }
    createNewPage(context) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const page = yield context.newPage();
            const intialScript = (0, fs_1.readFileSync)((0, path_1.join)(__dirname, 'utils/initial-context.js')).toString();
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BrowserManager = void 0;
var browser_manager_1 = __webpack_require__("./libs/robot/core/src/managers/browser.manager.ts");
...
const core_1 = __webpack_require__("./libs/robot/core/src/index.ts");
const shared_1 = __webpack_require__("./libs/views/shared/src/index.ts");
const handlers_1 = __webpack_require__("./libs/robot/gmail/src/handlers.ts");
...
const gmail_auth_handler_1 = __webpack_require__("./libs/handlers/gmail/gmail-auth-handler/src/index.ts");
const gmail_change_name_handler_1 = __webpack_require__("./libs/handlers/gmail/gmail-change-name-handler/src/index.ts");
// import { GmailReportingHandler } from '@gwarm/gmail-reporting-handler';
const gmail_remove_devices_handler_1 = __webpack_require__("./libs/handlers/gmail/gmail-remove-devices-handler/src/index.ts");
const gmail_reply_handler_1 = __webpack_require__("./libs/handlers/gmail/gmail-reply-handler/src/index.ts");
const gmail_setup_rule_handler_1 = __webpack_require__("./libs/handlers/gmail/gmail-setup-rule-handler/src/index.ts");
...
const hotmail_auth_handler_1 = __webpack_require__("./libs/handlers/hotmail/hotmail-auth-handler/src/index.ts");
...
const tslib_1 = __webpack_require__("tslib");
const handlers_1 = __webpack_require__("./libs/robot/hotmail/src/handlers.ts");
const core_1 = __webpack_require__("./libs/robot/core/src/index.ts");
const shared_1 = __webpack_require__("./libs/views/shared/src/index.ts");
let Hotmail = class Hotmail extends core_1.Isp {
};
Hotmail = tslib_1.__decorate([
    (0, core_1.ISP)(shared_1.IspEnum.HOTMAIL, handlers_1.HOTMAIL_HANDLERS)
], Hotmail);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/robot/hotmail/src/hotmail.ts"), exports);
...
const proton_auth_handler_1 = __webpack_require__("./libs/handlers/proton/proton-auth-handler/src/index.ts");
const proton_change_name_handler_1 = __webpack_require__("./libs/handlers/proton/proton-change-name-handler/src/index.ts");
const proton_setup_rule_handler_1 = __webpack_require__("./libs/handlers/proton/proton-setup-rule-handler/src/index.ts");
...
Object.defineProperty(exports, "Proton", ({ enumerable: true, get: function () { return proton_1.Proton; } }));
...
const core_1 = __webpack_require__("./libs/robot/core/src/index.ts");
const shared_1 = __webpack_require__("./libs/views/shared/src/index.ts");
const handlers_1 = __webpack_require__("./libs/robot/proton/src/handlers.ts");
...
const ApiWithTokenResponse = (options) => {
    return (0, common_1.applyDecorators)((0, swagger_1.ApiOperation)(options.operationOptions), (0, swagger_1.ApiResponse)(Object.assign({ status: 200 }, options.responseMetadata)));
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/shared/src/decorators/api-with-token.decorator.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/shared/src/shared.module.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/shared/src/services/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/shared/src/decorators/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/shared/src/utils/index.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/shared/src/services/token.service.ts"), exports);
...
TokenService = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof express_1.Request !== "undefined" && express_1.Request) === "function" ? _a : Object])
], TokenService);
...
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const token_service_1 = __webpack_require__("./libs/shared/src/services/token.service.ts");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isSuccess = exports.isFail = exports.success = exports.fail = void 0;
const fail = (error) => ({
    isFail: true,
    error,
});
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/shared/src/utils/either.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/shared/src/utils/distributed-random.ts"), exports);
...
], Application.prototype, "capacity", void 0);
exports.Application = Application;
...
tslib_1.__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", String)
], Email.prototype, "confirmationEmail", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    (0, class_validator_1.IsEmail)(),
    (0, class_validator_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", String)
], Email.prototype, "session", void 0);
exports.Email = Email;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/core/payload.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/core/result.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/core/task.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/core/response.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/core/email.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/core/job-config.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/core/application.ts"), exports);
...
const tslib_1 = __webpack_require__("tslib");
const swagger_1 = __webpack_require__("@nestjs/swagger");
const enums_1 = __webpack_require__("./libs/views/shared/src/enums/index.ts");
class Response {
}
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Number)
], Response.prototype, "taskId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Number)
], Response.prototype, "jobId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ enum: enums_1.TaskEnum }),
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum) === "function" ? _a : Object)
...
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    tslib_1.__metadata("design:type", String)
], Response.prototype, "image", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Number)
], Response.prototype, "application", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Number)
], Response.prototype, "emailId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Number)
], Response.prototype, "applicationId", void 0);
...
const swagger_1 = __webpack_require__("@nestjs/swagger");
const enums_1 = __webpack_require__("./libs/views/shared/src/enums/index.ts");
const email_1 = __webpack_require__("./libs/views/shared/src/core/email.ts");
class Task {
}
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
...
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof email_1.Email !== "undefined" && email_1.Email) === "function" ? _b : Object)
], Task.prototype, "email", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ enum: enums_1.IspEnum }),
    tslib_1.__metadata("design:type", typeof (_c = typeof enums_1.IspEnum !== "undefined" && enums_1.IspEnum) === "function" ? _c : Object)
], Task.prototype, "isp", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Number)
], Task.prototype, "emailId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Number)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/enums/task.enum.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/enums/isp.enum.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/enums/task-status.enum.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/tasks/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/core/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/enums/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/results/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/jobs/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/responses/index.ts"), exports);
...
const enums_1 = __webpack_require__("./libs/views/shared/src/enums/index.ts");
const payloads_1 = __webpack_require__("./libs/views/shared/src/payloads/index.ts");
const responses_1 = __webpack_require__("./libs/views/shared/src/responses/index.ts");
const results_1 = __webpack_require__("./libs/views/shared/src/results/index.ts");
const tasks_1 = __webpack_require__("./libs/views/shared/src/tasks/index.ts");
...
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/jobs/auth-config.job.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/jobs/change-name-config.job.ts"), exports);
const add_rule_config_job_1 = __webpack_require__("./libs/views/shared/src/jobs/add-rule-config.job.ts");
const auth_config_job_1 = __webpack_require__("./libs/views/shared/src/jobs/auth-config.job.ts");
const change_name_config_job_1 = __webpack_require__("./libs/views/shared/src/jobs/change-name-config.job.ts");
const remove_devices_config_job_1 = __webpack_require__("./libs/views/shared/src/jobs/remove-devices-config.job.ts");
const reply_config_job_1 = __webpack_require__("./libs/views/shared/src/jobs/reply-config.job.ts");
const setup_rule_config_job_1 = __webpack_require__("./libs/views/shared/src/jobs/setup-rule-config.job.ts");
exports.JOBS_CONFIG = [
...
const core_1 = __webpack_require__("./libs/views/shared/src/core/index.ts");
const enums_1 = __webpack_require__("./libs/views/shared/src/enums/index.ts");
const remove_device_response_1 = __webpack_require__("./libs/views/shared/src/responses/remove-device.response.ts");
const tasks_1 = __webpack_require__("./libs/views/shared/src/tasks/index.ts");
...
const enums_1 = __webpack_require__("./libs/views/shared/src/enums/index.ts");
const reply_payload_1 = __webpack_require__("./libs/views/shared/src/payloads/reply.payload.ts");
const responses_1 = __webpack_require__("./libs/views/shared/src/responses/index.ts");
const results_1 = __webpack_require__("./libs/views/shared/src/results/index.ts");
const tasks_1 = __webpack_require__("./libs/views/shared/src/tasks/index.ts");
...
const payload_1 = __webpack_require__("./libs/views/shared/src/core/payload.ts");
...
tslib_1.__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", String)
], ChangeNamePayload.prototype, "name", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ default: false }),
    (0, class_validator_1.IsBoolean)(),
    tslib_1.__metadata("design:type", Boolean)
], ChangeNamePayload.prototype, "withPlus", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ default: 0, type: Number }),
    tslib_1.__metadata("design:type", Number)
], ChangeNamePayload.prototype, "numberOfPoints", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    (0, class_validator_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], ChangeNamePayload.prototype, "extension", void 0);
...
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/auth.payload.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/change-name.payload.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/reporting.payload.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/reporting/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/reply.payload.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/remove-devices.payload.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/add-rule.payload.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/setup-rule.payload.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/create-proton.payload.ts"), exports);
const auth_payload_1 = __webpack_require__("./libs/views/shared/src/payloads/auth.payload.ts");
const change_name_payload_1 = __webpack_require__("./libs/views/shared/src/payloads/change-name.payload.ts");
const reporting_payload_1 = __webpack_require__("./libs/views/shared/src/payloads/reporting.payload.ts");
const reply_payload_1 = __webpack_require__("./libs/views/shared/src/payloads/reply.payload.ts");
const remove_devices_payload_1 = __webpack_require__("./libs/views/shared/src/payloads/remove-devices.payload.ts");
const add_rule_payload_1 = __webpack_require__("./libs/views/shared/src/payloads/add-rule.payload.ts");
const setup_rule_payload_1 = __webpack_require__("./libs/views/shared/src/payloads/setup-rule.payload.ts");
const create_proton_payload_1 = __webpack_require__("./libs/views/shared/src/payloads/create-proton.payload.ts");
exports.PAYLOADS = [
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], Placeholder.prototype, "key", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ type: String }),
    tslib_1.__metadata("design:type", Array)
], Placeholder.prototype, "value", void 0);
...
tslib_1.__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", String)
], ReplyPayload.prototype, "filter", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        isArray: true,
        type: Placeholder,
    ...
    tslib_1.__metadata("design:type", Array)
], ReplyPayload.prototype, "placeholders", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", String)
], ReplyPayload.prototype, "body", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ default: 500 }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsPositive)(),
    tslib_1.__metadata("design:type", Number)
], ReplyPayload.prototype, "limit", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ default: false }),
    (0, class_validator_1.IsBoolean)(),
    tslib_1.__metadata("design:type", Boolean)
], ReplyPayload.prototype, "reset", void 0);
...
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    tslib_1.__metadata("design:type", String)
], ReportingFilterPayload.prototype, "subject", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    tslib_1.__metadata("design:type", String)
], ReportingFilterPayload.prototype, "from", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    tslib_1.__metadata("design:type", String)
], ReportingFilterPayload.prototype, "email", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        default: new Date().setDate(new Date().getDate() - 1),
    }),
    tslib_1.__metadata("design:type", Number)
], ReportingFilterPayload.prototype, "date", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Number)
], ReportingInboxPyload.prototype, "archive", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        default: 0,
        minimum: 0,
    ...
    tslib_1.__metadata("design:type", Number)
], ReportingInboxPyload.prototype, "delete", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        default: 0,
        minimum: 0,
    ...
    tslib_1.__metadata("design:type", Number)
], ReportingInboxPyload.prototype, "star", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        default: 0,
        minimum: 0,
    ...
    tslib_1.__metadata("design:type", Number)
], ReportingInboxPyload.prototype, "important", void 0);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/reporting/inbox.payloads.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/reporting/spam.payloads.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/payloads/reporting/promotion.payloads.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ReportingPromitionsOthers = exports.ReportingPromotionsActions = exports.ReportingPromotionsPayload = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ReportingSpamOthers = exports.ReportingSpamActions = exports.ReportingSpamPayload = void 0;
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.ADD_RULE) === "function" ? _a : Object)
], AddRuleResponse.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof results_1.AddRuleRsult !== "undefined" && results_1.AddRuleRsult) === "function" ? _b : Object)
], AddRuleResponse.prototype, "result", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.AUTHENTICATION) === "function" ? _a : Object)
], AuthResponse.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof results_1.AuthResult !== "undefined" && results_1.AuthResult) === "function" ? _b : Object)
], AuthResponse.prototype, "result", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.CHANGE_NAME) === "function" ? _a : Object)
], ChangeNameResponse.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof results_1.ChangeNameResult !== "undefined" && results_1.ChangeNameResult) === "function" ? _b : Object)
], ChangeNameResponse.prototype, "result", void 0);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/responses/auth.response.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/responses/change-name.response.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/responses/reply.response.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/responses/add-rule.response.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/responses/setup-rule.response.ts"), exports);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.REMOVE_DEVICES) === "function" ? _a : Object)
], RemoveDevicesResponse.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof results_1.AddRuleRsult !== "undefined" && results_1.AddRuleRsult) === "function" ? _b : Object)
], RemoveDevicesResponse.prototype, "result", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.REPLY) === "function" ? _a : Object)
], ReplyResponse.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof results_1.ReplyResult !== "undefined" && results_1.ReplyResult) === "function" ? _b : Object)
], ReplyResponse.prototype, "result", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.SETUP_RULE) === "function" ? _a : Object)
], SetupRuleResponse.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof results_1.SetupRuleResult !== "undefined" && results_1.SetupRuleResult) === "function" ? _b : Object)
], SetupRuleResponse.prototype, "result", void 0);
...
const result_1 = __webpack_require__("./libs/views/shared/src/core/result.ts");
...
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", String)
], AuthResult.prototype, "token", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", String)
], AuthResult.prototype, "error", void 0);
...
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", String)
], ChangeNameResult.prototype, "name", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", String)
], ChangeNameResult.prototype, "oldName", void 0);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/results/change-name.result.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/results/auth.result.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/results/pagination.result.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/results/reporting.result.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/results/reply.result.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/results/add-rule.result.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/results/remove-devices.result.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/results/setup-rule.result.ts"), exports);
...
tslib_1.__decorate([
    ...
    (0, class_validator_1.IsNumber)(),
    tslib_1.__metadata("design:type", Number)
], PaginationResult.prototype, "size", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsNumber)(),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    ...
    (0, class_validator_1.IsNumber)(),
    tslib_1.__metadata("design:type", Number)
], PaginationResult.prototype, "totalItems", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsNumber)(),
    tslib_1.__metadata("design:type", Number)
], PaginationResult.prototype, "totalPages", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsBoolean)(),
    tslib_1.__metadata("design:type", Boolean)
], PaginationResult.prototype, "hasPrev", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsBoolean)(),
    tslib_1.__metadata("design:type", Boolean)
], PaginationResult.prototype, "hasNext", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Array)
], PaginationResult.prototype, "content", void 0);
...
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Number)
], ReplyResult.prototype, "count", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Boolean)
], ReplyResult.prototype, "limited", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Boolean)
], ReplyResult.prototype, "blocked", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", Number)
], ReplyResult.prototype, "bounce", void 0);
...
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ type: enums_1.TaskEnum.ADD_RULE, default: enums_1.TaskEnum.ADD_RULE }),
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.ADD_RULE) === "function" ? _a : Object)
], AddRuleTask.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof payloads_1.AddRulePayload !== "undefined" && payloads_1.AddRulePayload) === "function" ? _b : Object)
], AddRuleTask.prototype, "payload", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.AUTHENTICATION) === "function" ? _a : Object)
], AuthTask.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof payloads_1.AuthPayload !== "undefined" && payloads_1.AuthPayload) === "function" ? _b : Object)
], AuthTask.prototype, "payload", void 0);
...
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ type: enums_1.TaskEnum.CHANGE_NAME, default: enums_1.TaskEnum.CHANGE_NAME }),
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.CHANGE_NAME) === "function" ? _a : Object)
], ChangeNameTask.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof payloads_1.ChangeNamePayload !== "undefined" && payloads_1.ChangeNamePayload) === "function" ? _b : Object)
], ChangeNameTask.prototype, "payload", void 0);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/tasks/auth.task.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/tasks/change-name.task.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/tasks/reply.task.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/tasks/remove-devices.task.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./libs/views/shared/src/tasks/add-rule.task.ts"), exports);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.REMOVE_DEVICES) === "function" ? _a : Object)
], RemoveDevicesTask.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof payloads_1.RemoveDevicesPayload !== "undefined" && payloads_1.RemoveDevicesPayload) === "function" ? _b : Object)
], RemoveDevicesTask.prototype, "payload", void 0);
...
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ type: enums_1.TaskEnum.REPLY, default: enums_1.TaskEnum.REPLY }),
    tslib_1.__metadata("design:type", typeof (_a = typeof enums_1.TaskEnum !== "undefined" && enums_1.TaskEnum.REPLY) === "function" ? _a : Object)
], ReplyTask.prototype, "action", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)(),
    tslib_1.__metadata("design:type", typeof (_b = typeof payloads_1.ReplyPayload !== "undefined" && payloads_1.ReplyPayload) === "function" ? _b : Object)
], ReplyTask.prototype, "payload", void 0);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
const app_module_1 = __webpack_require__("./apps/robots/robot-actions/src/app/app.module.ts");
const core_1 = __webpack_require__("@nestjs/core");
